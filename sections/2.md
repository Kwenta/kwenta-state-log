...
The Kwenta Council will be responsible for voting to pass or block KIPs. Proposals must reach a majority to pass (3/5 votes). Meta-Governance proposals require n-1 votes are needed, where n is the total number of current council seats. The KIP vote window is set within the timeframe of 3 to 7 days.
