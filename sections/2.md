...
6. [devDAO](#devdao)
7. [marketingDAO](#marketingdao)
8. [Product Elite](#product-elite)
9. [DAO Role Compensation](#dao-role-compensation)
10. [protocolDAO](#protocoldao)
...
The Kwenta Council will be responsible for voting to pass or block KIPs. Proposals must reach a majority to pass (3/5 votes). Meta-Governance proposals require n-1 votes are needed, where n is the total number of current council seats. The KIP vote window is set within 7 days.
...
* To consider a council member inactive, the KIP votes need to be at least 7 days apart and each KIP should have at least a 3 days vote window.
...
- The adminDAO is responsible for stategic development and subsequent delivering on roadmap goals by coordinating with other DAO roles
...
A Gnosis Safe has been created with a 3/5 signing requirement. Three members are protocol engineers (CCs). The initial protocol engineers are assigned by the adminDAO. The two remaining signature bodies are the adminDAO and the Council.
