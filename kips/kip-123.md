...
Subsequent minting KSX minting is a ratio of added KWENTA to the KWENTA that exists in the vault. Therefore minted KSX is a fair share representation of KWENTA in the vault. For example,
